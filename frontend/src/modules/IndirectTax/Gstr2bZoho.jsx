...
export default function Gstr2bZoho() {
  ...
  const handleRunAutomation = async () => {
    ...
    try {
      const response = await fetch('http://127.0.0.1:5000/api/indirect-tax/gstr2b-zoho', {
        method: 'POST',
        body: formData,
      });
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 animate-in fade-in duration-500">
      ...
      <div className="flex items-center gap-3 border-b border-slate-800 pb-4">
        ...
        <h2 className="text-xl font-bold text-white tracking-tight">GSTR-2B Processing <span className="text-slate-600">|</span> Zoho</h2>
      </div>
